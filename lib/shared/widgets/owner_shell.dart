...
class OwnerShell extends ConsumerWidget {
  ...
  int _index(String loc) {
    if (loc.startsWith('/owner/dashboard')) { return 0; }
    if (loc.startsWith('/owner/calendar') || loc.startsWith('/owner/courses') ||
        loc.startsWith('/owner/rooms')) { return 1; }
    if (loc.startsWith('/owner/clients')) { return 2; }
    if (loc.startsWith('/owner/team') || loc.startsWith('/owner/plans') ||
